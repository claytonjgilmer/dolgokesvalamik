...
namespace ctr
{
	...
	protected:
		ctr::vector<ctr::fixedvector<T,poolsize>> m_poolbuf;
	private:
	...
	{
		return m_poolbuf[i_index & poolsize][i_index >> (math::logn<poolsize>())];
	}
	...
	{
		m_poolbuf[i_index & poolsize][i_index >> (math::logn<poolsize>())]=m_poolbuf.back().back();
